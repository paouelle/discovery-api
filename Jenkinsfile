...
pipeline {
    ...
    environment {
        ...
        GITHUB_REPONAME = 'discovery-api'
	GITHUB_KEY = 'discovery-api-github-key'
    }
    parameters {
            ...
            string(name: 'RELEASE_TAG', defaultValue: 'NA', description: 'The release tag for this version. An NA value will result in ${GITHUB_REPONAME}-RELEASE_VERSION')
